...
The default `topicBoost` (0.05) and `candidateK` (5) come from a 2026-08-14 calibration run on the reference corpus (289 memories, German/English mixed, golden set of 16 positive prompts + 4 negative controls, Ollama embeddings, relevance floor swept per model). Aggregate precision/recall/MRR over the positive prompts, negative controls (NK) reported separately:
